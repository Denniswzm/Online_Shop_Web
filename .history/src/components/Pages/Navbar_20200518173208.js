...
import NavCartPreview from '../const/NavCartPreview';
...
render() {
    return (
        <div>
            ...
            <Menu id="main-navbar" className = 'nvbar' mode="horizontal" onClick={this.handleClick} selectedKeys={[this.state.current]} style={{ height : 60}}>
                <SubMenu className='department' title="Department" key="Department" icon={<AppstoreOutlined />}>
                ...
                <Menu.Item key="WeeklySpecial" className = 'WeeklySpecial' >
                    <Link className = 'text1' to="/map">
                        Weekly Special
                    </Link>
                </Menu.Item>
                <Menu.Item key="NewArrivals" className = 'NewArrivals'>
                    <Link className = 'text1' to="/advice">
                        New Arrivals
                    </Link>
                </Menu.Item>
                <Menu.Item key="OnSale" className = 'OnSale'>
